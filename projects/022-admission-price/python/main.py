...
print(f"Your group is composed by {under_3} child/children equal or under 2 years old , {under_13} child/children equal or under 12 years old, {senior} adult/s over 65 and {adult} adult/s between 12 and 65. Total amount for tickets is {total} $")
