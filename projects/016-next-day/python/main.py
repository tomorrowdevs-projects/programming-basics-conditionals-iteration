...
for i in range(0,1):
    if month > 12 or month < 1 or day > 31 and month == 4 or day > 31 and month == 6 or day >31 and month == 9 or day > 31 and month == 11 or day > 30 and month == 1 or day > 30 and month == 3 or day > 30 and month == 5 or day > 30 and month == 7 or day > 30 and month == 8 or day > 30 and month == 10 or day > 30 and month == 12 or (leap_year == False and month == 2 and day > 28) or (leap_year == True and month == 2 and day > 29):
        print('error')
    else:
